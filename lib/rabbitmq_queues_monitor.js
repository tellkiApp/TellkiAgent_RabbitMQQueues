...
metrics.push({ id: '9999:Memory:4',                       state: false, get: function(o) { return (o['memory'] / 1024 / 1024).toFixed(2); } });
metrics.push({ id: '9999:Consumers:4',                    state: false, get: function(o) { return (o['consumers']); } });
metrics.push({ id: '9999:Pending Acks:4',                 state: false, get: function(o) { return (o['backing_queue_status']['pending_acks']); } });
metrics.push({ id: '9999:Messages:4',                     state: false, get: function(o) { return (o['messages']); } });
metrics.push({ id: '9999:Messages Rate:4',                state: false, get: function(o) { return (o['messages_details']['rate']); } });
metrics.push({ id: '9999:Messages Unacknowledged:4',      state: false, get: function(o) { return (o['messages_unacknowledged']); } });
metrics.push({ id: '9999:Messages Unacknowledged Rate:4', state: false, get: function(o) { return (o['messages_unacknowledged_details']['rate']); } });
metrics.push({ id: '9999:Messages Ready:4',               state: false, get: function(o) { return (o['messages_ready']); } });
metrics.push({ id: '9999:Messages Ready Rate:4',          state: false, get: function(o) { return (o['messages_ready_details']['rate']); } });
